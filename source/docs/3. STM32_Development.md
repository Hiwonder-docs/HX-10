...
2. Double-click STM32 serial port programming software **FlyMcu** <img src="..\_static\media\chapter_1\section_4\image2.png" class="common_img" style="width:60px;"/>.
...
5. Click **Start Programming**, then press the **RST** button on the controller. The program will automatically begin downloading. Once the following content appears in the log output on the right, the program download will be complete.
