...
This section specifies the servo **Start** and **End** positions, which can be set within a range of −30719 to 30719 steps. **Delay** is the time gap between issuing the **Start** and **End** commands, and **Speed** is configured in the control area. After clicking **Start Scan**, the servo repeatedly moves between the **Start** and **End** positions.
